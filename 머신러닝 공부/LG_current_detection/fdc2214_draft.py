...
LDC1614_RCOUNT_CH3          = 0x0B
LDC1614_RCOUNT_CH1          = 0x09
LDC1614_SETTLECOUNT_CH3     = 0x13
LDC1614_SETTLECOUNT_CH1     = 0x11
LDC1614_CLOCK_DIVIDERS_CH3  = 0x17
...
LDC1614_DRIVE_CURRENT_CH3   = 0x21
...
config_singlechannel = {
    LDC1614_RCOUNT_CH3:         0xFFFF,
    LDC1614_RCOUNT_CH1:         0x0004, # CH1 is set up in dummy mode here.
    LDC1614_SETTLECOUNT_CH3:    0x8692,
    LDC1614_SETTLECOUNT_CH1:    0x0001,
    LDC1614_CLOCK_DIVIDERS_CH3: 0x1001,
    LDC1614_CLOCK_DIVIDERS_CH1: 0x1001,
    LDC1614_DRIVE_CURRENT_CH3:  0x4A40, # Idrive=9
...
def main(filename):
    ...
    while True:
        ...
        if raw_ch0 and not (raw_ch0 & 0xF0000000):
            ...
            C_sensor = 1 / L*(2*np.pi*f_sensor)*(2*np.pi*f_sensor) - C
            print(C_sensor)
